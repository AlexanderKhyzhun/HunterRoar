package com.yotalabs.hunterroar.view;
...
import static com.yotalabs.hunterroar.utils.AudioUtilsKt.findAudioLength;
import static com.yotalabs.hunterroar.utils.SamplingUtilsKt.getExtremes;
import static com.yotalabs.hunterroar.utils.TextUtilsKt.getFontSize;
...
public class WaveformView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTextPaint.setTextSize(getFontSize(getContext(), android.R.attr.textAppearanceSmall));
    ...
    private void calculateAudioLength() {
        ...
        mAudioLength = findAudioLength(mSamples.length, mSampleRate, mChannels);
    }
